...
function detectLanguage() {
    ...
    // In a real application, this would be an API call For demo purposes, we're simulating detection with simple rules
...
window.addEventListener('DOMContentLoaded', () => {
    inputArea.value = "Hello! I'm Jawahar from Chennai,Willing to get a job as a Full stack developer";
    inputArea.dispatchEvent(new Event('input'));
});